...
parser.add_argument('--pth_path', type=str, default='./snapshots/PraNet20-90Perc/Net_epoch_best.pth')

for _data_name in ['test']:#, 'CVC-ClinicDB', 'Kvasir', 'CVC-ColonDB', 'ETIS-LaribPolypDB']:
